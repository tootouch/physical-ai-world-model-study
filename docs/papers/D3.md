...
이 protocol은 산업공학적으로도 흥미롭다. data collection을 operator의 자율성에만 맡기지 않고, GUI와 randomization으로 task coverage와 scene variation을 설계한다.
...
- DSBA 관점에서 distributed robot data collection protocol을 작업 배정, 품질 관리, 샘플링 최적화 문제로 모델링할 수 있을까?
