...
DSBA 관점에서는 world model이 "현장을 예측하는 digital twin"과 닮아 있다는 점을 강조할 수 있다. 다만 Physical AI의 world model은 단순 시뮬레이션이 아니라 action-conditioned, uncertainty-aware, policy-coupled prediction이어야 한다.
