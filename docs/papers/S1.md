...
이 논문은 2024년 초 기준 survey라 최신 WAM/World Action Model까지 포괄하지는 못한다. 하지만 curriculum 초반에 분야의 vocabulary를 잡는 데 좋다. 특히 datasets, simulators, benchmarks가 별도 구성 요소로 다뤄진다는 점은 DSBA 관점에서 중요하다.
